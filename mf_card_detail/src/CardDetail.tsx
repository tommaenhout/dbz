    ...
    <div className="flex justify-center">
      {card ? (
        <>
          ...
          />
          <div className="md:ml-8 p-6 bg-white rounded-lg shadow-lg max-w-lg">
            <h2 className="text-3xl text-black font-bold mb-4">{card.name}</h2>

            <div className="mb-6 grid grid-cols-2 gap-4">
              <div className="rounded-md">
                <h3 className="font-bold mb-1">Basic Info</h3>{" "}
                <p>
                  <span>Gender:</span> {card.gender}
                </p>
                <p>
                  <span>Affiliation:</span> {card.affiliation}
                </p>
              </div>
              ...
              <div className="rounded-md">
                ...
                <p>
                  <span>Max Power:</span> {card.maxKi}
                </p>
              </div>
            </div>
            ...
            {card.originPlanet && (
              <div className="mb-6 rounded-md">
                ...
                <p>
                  <span>Name:</span> {card.originPlanet.name}
                </p>
                <p>
                  <span>Status:</span>{" "}
                  {card.originPlanet.isDestroyed ? "Destroyed" : "Intact"}
                </p>
              </div>
            )}
